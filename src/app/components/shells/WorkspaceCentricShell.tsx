import { LayoutDashboard, Network, Users, Settings, HelpCircle } from 'lucide-react';

export function WorkspaceCentricShell() {
  return (
    <div className="bg-gray-50 rounded-md border border-gray-200 overflow-hidden p-6" style={{ height: '500px' }}>
      {/* Labels positioned outside the skeleton */}
      ...
      <div className="border-2 border-dashed border-blue-300 rounded bg-white h-full flex" style={{ height: 'calc(100% - 32px)' }}>
        ...
        <div className="w-[56px] border-r-2 border-dashed border-blue-300 bg-white py-4 relative flex flex-col items-center">
          {/* App logo */}
          <div className="w-6 h-6 bg-gray-300 rounded mb-6"></div>
